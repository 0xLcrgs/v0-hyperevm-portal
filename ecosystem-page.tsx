...
const projects = [
  ...
  },
  {
    id: 175,
    name: "Neutral Trade",
    description: "Neutral Trade is the on-chain multi-strategy hedge fund, built by experienced quants and traders from Goldman Sachs and a Top 3 Global Hedge Fund.",
    categories: ["Yield"],
    status: "Live",
  ...
  },
  {
    id: 181,
    name: "HyperData",
    description: "Explore our new heatmaps for Hyperliquid spot & perps markets. Quickly track daily changes, volumes, and market caps. Enjoy enhanced upgrades for a smoother user experience too!",
    categories: ["Tools"],
    status: "Live",
  ...
  },
  {
    id: 161,
    name: "Mintify",
    description: "Mintify is the best consumer experience to trade every asset, every network, and every market directly onchain. Mintify is part of a next generation of platforms that support real-time, direct onchain trading of your favorite economies.  ",
  ...
  },
  {
    ...
    name: "IVX",
    description:
      "Trade the most liquid 0dte markets in all of crypto on $ETH and $BTC",
    categories: ["Options"],
    status: "Coming Soon",
